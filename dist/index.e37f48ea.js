...
const controlRecipes = async function() {
    try {
        ...
        (0, _bookmarksViewJsDefault.default).update(_moduleJs.state.bookmarks);
        // 1) loading recipe
...
const controlSearchResult = async function() {
    try {
        ...
        (0, _resultsViewJsDefault.default).render(_moduleJs.getSearchResultsPage());
...
const controlPagination = function(goToPage) {
    //Render NEW results
    (0, _resultsViewJsDefault.default).render(_moduleJs.getSearchResultsPage(goToPage));
...
},{"../internals/export":"dIGt4","../internals/global":"i8HOC","../internals/task":"7jDg7"}],"Qr6Q3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkupIngredient(ing) {
        console.log((0, _fractyDefault.default)(0.4));
        return `
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","fracty":"hJO4d"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg"); //Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (this._currentPage === 1 && numPages > 1) return this.nextButton();
        // Last page
        if (this._currentPage === numPages && numPages > 1) return this.previousButton();
        // Other page
        if (this._currentPage < numPages) return this.previousButton() + this.nextButton();
